(() => {
  ...
  function createBrandMarkup() {
    const credit = currentPage === "/"
      ? '<span class="global-header-credit">powered by Alonsos e Branco.</span>'
      : "";

    return `
      <a href="/" aria-label="Voltar ao inicio" class="global-header-brand">
  ...
  function createMobileActionMarkup() {
    ...
    const mobileLabel = targetLink.href === "about-us" ? "Sobre nós" : targetLink.label;
  ...
  function isHeaderCandidate(element) {
    ...
    const hasNavHint = element.querySelector('a[href="quem-somos"], a[href="about-us"], .brand-nav, nav');
