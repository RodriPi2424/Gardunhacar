(function () {
  ...
  async function handleSaveCar(pathname, options) {
    ...
    const hasExistingImageSelection = Object.prototype.hasOwnProperty.call(payload, "existingImageUrls")
      || Object.prototype.hasOwnProperty.call(car || {}, "image_urls");
    const requestedExistingImageUrls = Array.isArray(payload.existingImageUrls)
    ...
    if (isUpdate) {
      ...
      imageUrls = hasExistingImageSelection
        ? [...orderedExistingImageUrls, ...imageUrls]
        : (imageUrls.length > 0 ? imageUrls : existingImageUrls);
    }
